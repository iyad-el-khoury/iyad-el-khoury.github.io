...
<div style="display: flex; gap: 1em; flex-wrap: wrap; margin: 2em 0;">
 ...
 To exploit the bilinearity of the Euclidean scalar product, it will be simpler to consider the norm squared of $$Z$$, that is to say the quantity $$\langle Z \mid Z\rangle$$. Calculating the expected value of $$\lVert Z \rVert^2$$ is direct:
...
<figure style="max-width: 520px; margin: 0.5em auto;">
